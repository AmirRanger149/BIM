#!/usr/bin/env python3
"""
Migration script to add 3D model support to gallery items.
Adds model_url and model_type columns to gallery_items table.
"""
...
def migrate():
    """Add model_url and model_type columns to gallery_items table"""
